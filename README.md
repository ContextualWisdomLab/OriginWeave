...
3. **Destination safety** — classify resolved addresses, bind a non-empty approved address set to each origin, reject DNS-set expansion, and reauthorize every redirect target.
