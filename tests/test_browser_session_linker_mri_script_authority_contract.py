...
class BrowserSessionMriLinkerScriptAuthorityContractTests(unittest.TestCase):
    """Keep GNU MRI linker command files inside reviewed Browser Session provenance."""
