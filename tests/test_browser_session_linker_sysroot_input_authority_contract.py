...
class BrowserSessionLinkerSysrootInputAuthorityContractTests(unittest.TestCase):
    """Keep linker sysroot selection outside repository-owned Browser Session builds."""
