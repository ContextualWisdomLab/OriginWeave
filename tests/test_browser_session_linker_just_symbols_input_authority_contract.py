...
class BrowserSessionLinkerJustSymbolsInputAuthorityContractTests(unittest.TestCase):
    """Keep GNU/LLD just-symbols files outside repository-owned Browser Session builds."""
