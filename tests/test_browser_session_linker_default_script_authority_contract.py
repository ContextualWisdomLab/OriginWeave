...
class BrowserSessionDefaultLinkerScriptAuthorityContractTests(unittest.TestCase):
    """Keep GNU/LLD default linker scripts inside reviewed Browser Session provenance."""
