...
class GapSnapshotInventoryConsistencyTests(unittest.TestCase):
    ...
    def test_current_live_state_is_distinct_from_dated_snapshot(self) -> None:
        ...
        for marker in (
            ...
            "18156473",
            "ten central required workflows",
            "codeql-pr.yml",
            "scorecard-pr.yml",
            "osv-scanner-pr.yml",
            ...
            "Noema job `99943871679` remains terminal failure",
            "DDD ownership correction #272 is Draft at exact head",
            "#273 is its Draft context-map/ubiquitous-language child at exact head `f34212f9dff07deb70dd5265ecbb00f36b0f69b0`",
            "Issue #276",
        ...
        for stale in (
            ...
            "coverage-evidence job `100098698802` remain queued",
        ):
