...
class GapSnapshotInventoryConsistencyTests(unittest.TestCase):
    ...
    def test_current_live_state_is_distinct_from_dated_snapshot(self) -> None:
        ...
        for marker in (
            ...
            "PR #252 now adopts #251 at `6569bf40b6595ac74c2f0a997d202137f07ba1db`",
            "1044 functions, 10699 lines, 13751 regions, 1192 branches",
            "PR #253 now adopts #252 at `afb623e4449b7cbf926fdcef7225ceaca822cfcf`",
            "1054 functions, 10747 lines, 13787 regions, 1194 branches",
            "Review `5120013340` remains unresolved",
            "PR #254 now adopts #253 at `b11b6c9bccd8335b58a4fb599f8ad29ac419637f`",
            "1061 functions, 10802 lines, 13843 regions, 1200 branches",
            "Review `5120077272` remains actionable",
            "Current #148 `bded4fc9d32e5e047cea99d182aa05ae2cd03bf6`",
            "all 247 Python contracts pass on Linux with zero skips",
            "Current #150 `d3c29359fd10e540ca9b3b2723bde6f94866cdb6`",
            "all 229 Python contracts pass on macOS and Linux",
            "#166 Strix run `33929688857` / job `101237371800` failed",
            "console classifier also matches ordinary denied-policy prose",
            "#219 Strix run `33925442296` / job `101226800608`",
            "six-hour GitHub job execution limit",
            "#240 Strix run `33925596890` / job `101227893828`",
            "Current #147 `3dff28d9bf2dd27b72507e39979d51b8bf140fb4`",
            "all six focused and all 228 native tests now pass",
            ...
            "Prior #255 source-owner repair is `ebac126d1632c94775c2454423575275eec45def`",
            "PR #255 now adopts #254 at `3e7057443d7c9532ff526acb5eefe8cd4778c767`",
            "PR #256 now adopts #255 at `ced4a851ca66c08d895a098725c7f0ad3ecf0c38`",
            "PR #257 now adopts #256 at `f4a8f2cbf515bea348f500b59615a9581c1b96a2`",
            "1082 functions, 11032 lines, 14086 regions, 1202 branches",
            "1088 functions, 11077 lines, 14146 regions, 1210 branches",
            "1093 functions, 11131 lines, 14202 regions, 1214 branches",
