...
class GapSnapshotInventoryConsistencyTests(unittest.TestCase):
    ...
    def test_current_live_state_is_distinct_from_dated_snapshot(self) -> None:
        ...
        for marker in (
            ...
            "PR #260 is Draft at exact head `9b6c6038de8c1ed7872b513f113c6392987a8217`",
            "PR #258 is Draft at exact head `a61c717e525eb94f5a4aaa68d3bfdabc9152edfd`",
            "PR #259 is Draft at exact head `3a36bd2aaacc4051a7a2b92ebe114307034481eb`",
            "PR #261 is Draft at exact head `7388e6a893b34e87ba965f061aaa26bf4d155b61`",
            "Repair PR #277 is Draft at exact head `16ab6d67fe668306224af0c17c4e7b3d423f2c97`",
