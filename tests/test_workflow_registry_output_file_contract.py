...
class WorkflowRegistryOutputFileContractTests(unittest.TestCase):
    ...
    def test_cleanup_failure_preserves_primary_error_and_closes_parent_descriptor(self) -> None:
        """Cleanup failure must not mask the primary write error or leak the parent fd."""

        namespace = runpy.run_path(
            str(AUDITOR), run_name="workflow_output_cleanup_failure_contract"
        )
