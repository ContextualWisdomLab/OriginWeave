...
class BrowserSessionRustResponseFileContractTests(unittest.TestCase):
    """Keep rustc/rustdoc response-file inputs inside reviewed Cargo provenance."""

    def test_top_level_rust_response_files_fail_closed(self) -> None:
        hostile_configs = (
    ...
    def test_at_sign_inside_non_response_argument_remains_allowed(self) -> None:
