...
- Verify WebDriver BiDi dated-TR claims against the canonical W3C publication page for immutable standards provenance; treat runtime compatibility as separate evidence that requires explicit adapter/browser qualification.
