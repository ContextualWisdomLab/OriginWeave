...
fn profile_error_is_a_standard_error_with_stable_nonsecret_display() {
    ...
    let cases = [
        (ProfileError::ProfileTooLarge, "profile exceeds the bounded size"),
        (ProfileError::UnsupportedProfile, "profile format is unsupported"),
        (ProfileError::MalformedLine, "profile contains a malformed line"),
        (
        ...
        (ProfileError::MissingField, "profile is missing a required field"),
        (ProfileError::InvalidValue, "profile field value is invalid"),
        (ProfileError::TooManyItems, "profile contains too many items"),
        ...
        (
            ProfileError::SecretImportFailed,
