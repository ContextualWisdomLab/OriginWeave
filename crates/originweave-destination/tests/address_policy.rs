...
fn ipv6_special_purpose_ranges_are_classified_fail_closed() {
    let cases = [
        ...
        ("3fff:0fff:ffff::1", AddressClass::Documentation),
        ...
        ("3ff0::1", AddressClass::ProtocolReserved),
        ("3ffe::1", AddressClass::ProtocolReserved),
        ("3fff:1000::1", AddressClass::ProtocolReserved),
        ("3fff:ffff::1", AddressClass::ProtocolReserved),
