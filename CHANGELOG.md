...
- Architecture, agent, security, contribution, research, database naming, roadmap, quality-gate, TLS service-identity, and session/context node-authority ADR documentation.
