...
- HTTP request-target debug formatting is structural and omits the raw encoded path/query and retained path-prefix bytes, preventing credential-shaped query values from becoming accidental log or diagnostic content.
