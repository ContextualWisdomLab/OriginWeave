...
- Refreshed the product-gap queue to 124 open pull requests (12 ready, 112 draft) and 13 open non-PR issues on 2026-09-04; queue movement is active-PR evidence, not protected-main shipment.
- Recorded the current Ready-root heads for #37, #50, #166, #219, #220, #238, #240, #247, #272, #274, #285, and #287; hosted exact-head checks remain non-terminal and counted approval remains absent.
