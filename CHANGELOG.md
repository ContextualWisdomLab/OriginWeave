...
- Refreshed the product-gap queue to 125 open pull requests (14 ready, 111 draft) and 13 open non-PR issues on 2026-09-05; queue movement is active-PR evidence, not protected-main shipment.
- Recorded the current Ready-root heads for #37, #50, #166, #219, #220, #229, #240, #248, #272, #274, #285, and #287; Ready #290 remains a #245-dependent child, #238's moving self-reference is delegated to live PR metadata, hosted exact-head checks remain non-terminal, and counted approval remains absent.
