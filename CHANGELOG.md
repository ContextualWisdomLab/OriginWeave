...
- Aligned the hourly product-development branch-coverage toolchain with the reviewed `nightly-2026-08-18` pin and corrected the official Dependabot Rust-toolchain reference.
