...
- Current delivery inventory: 125 open pull requests (12 ready, 113 draft); 14 open non-PR issues. Observed 2026-09-07; source acceptance remains revision-specific.
...
- Recorded the current-head OpenCode dispatch authorization failure for PR #46 (`33192478312` / `98921183278`) and the immediately preceding PR #238 head (`33192483900` / `98921203971`): the central validator rejected the maintainer actor because it was not the configured scheduler identity; no review verdict or approval was synthesized.
