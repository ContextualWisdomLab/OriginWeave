...
- Bounded browser-task runtime telemetry carrying real browser RSS, semantic-observation bytes, governed-action latency, and total task duration without inferring GPU or local-AI evidence.
