...
### Added
- Added a bounded Rust presentation-identity kernel for explicit browser-visible profiles and credential-free replay digests; applying those profiles to Chromium and proving page-observed effects remain separate adapter and browser-E2E work.
