...
- Added uncertainty-safe reduced-assurance classification for attached human tabs when trusted adapter evidence says an existing extension can influence page state; absence of known influence is not treated as proof of high assurance.
