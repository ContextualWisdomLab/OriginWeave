...
- Refreshed the active WebDriver BiDi and semantic-action stack evidence through exact heads #195, #242, #93, #95, #96, #101, and #102, including macOS fixture-race repairs and fail-closed policy, dispatch, disabled-state, and current-observation boundaries.
