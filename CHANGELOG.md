...
- Active pinned-Chrome Agent Task evidence verifies browser-computed role/name for the controlled input and submit targets before action; this remains test-harness semantic evidence and does not claim a product semantic observer or authority.
