...
- Recorded PR #210's current exact-head failures at `bea65643109449d63d367a35b8d9bf327ee7cb2c`: OpenCode had no current-head verdict and Strix exhausted three provider HTTP 500 attempts without a vulnerability report; no failure was promoted to passing evidence.
