...
- Explicit origin ports must contain ASCII decimal digits before numeric parsing, preventing Rust-only signed spellings such as a leading `+` from diverging from browser URL port syntax.
