...
- Architecture, agent, security, contribution, research, database naming, roadmap, quality-gate, TLS service-identity, and hourly agent credential-boundary ADR documentation.
