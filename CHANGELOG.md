...
- Recorded current-head OpenCode dispatch authorization failures for PR #46 (`33192478312` / `98921183278`) and PR #238 (`33192483900` / `98921203971`): the central validator rejected the maintainer actor because it was not the configured scheduler identity; no review verdict or approval was synthesized.
