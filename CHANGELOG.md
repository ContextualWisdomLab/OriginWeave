...
- Hardened the controlled pinned-Chrome fixture server against symlink escapes outside its fixture root and made numeric `/proc` process snapshots skip symlinked or non-directory entries before reading status files.
