...
- Credential-free sensitive-handle lifecycle evidence records issuance, exclusive expiry, bounded uses, observed resolution count, and revocation without storing opaque handle tokens or protected values.
