...
- Added a fail-closed Chrome-permission separation boundary so reviewed Manifest V3 compatibility permissions, including `downloads`, can never mint any OriginWeave Agent action authority.
