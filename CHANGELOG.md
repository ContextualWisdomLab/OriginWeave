...
- Recorded the current Ready-root heads for #37, #50, #166, #219, #220, #229, #240, #248, #272, #274, #285, and #287; Draft #290 remains a #245-dependent workflow-owner candidate, #238's moving self-reference is delegated to live PR metadata, hosted exact-head checks remain non-terminal, and counted approval remains absent.
