...
- Read-only workflow-registry audit evidence that binds complete paginated GitHub Actions inventory to exact protected-main state and fails closed on ambiguous scalar types, including noncanonical negative-zero integers, workflow identities, paths, timestamps, and ownership.
