...
- Refreshed the product-gap queue to 124 open pull requests (9 ready, 115 draft) and 13 open non-PR issues on 2026-09-04; queue movement is active-PR evidence, not protected-main shipment.
- Recorded the current Ready-root heads for #37, #50, #219, #220, #238, #240, #247, #274, and #287; hosted exact-head checks remain non-terminal and counted approval remains absent.
