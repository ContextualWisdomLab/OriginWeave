...
Observed at (UTC): `2026-09-04T23:29:48Z`.
...
- Full live search returns **124 open pull requests: 10 Ready/non-draft and 114 Draft; 13 open non-PR issues**. PR #166 became Ready after adopting current protected main and passing its full local gates; queue movement is not protected-main delivery.
