...
Observed at (UTC): `2026-09-04T22:38:44Z`.
...
- Full live search returns **124 open pull requests: 6 Ready/non-draft and 118 Draft; 13 open non-PR issues**. PR #238 is the sixth Ready item after its exact-head local gates completed; queue movement is not protected-main delivery.
