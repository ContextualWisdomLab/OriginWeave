...
Observed at (UTC): `2026-09-04T23:19:40Z`.
...
- Full live search returns **124 open pull requests: 8 Ready/non-draft and 116 Draft; 13 open non-PR issues**. PR #220 became the eighth Ready item after adopting current protected main and passing its full local gates; queue movement is not protected-main delivery.
