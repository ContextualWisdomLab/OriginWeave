...
- PR #229 is Draft at exact head `7ae426e760e8351ee792ce9df4266d7e7483d0d4`. Test-only predecessor `ffd91290479c77ff1d675d4520e1776c990ba4d5` required a narrow presentation-identity changelog statement after the feature lane correctly relinquished volatile baseline ownership; the current repair adds exactly that feature-local entry while retaining the boundary that Chromium application and page-observed effectiveness remain separate adapter/browser-E2E work. Current-head CI/security runs remain non-terminal.
...
| #219 | Ready | `0841d2ab3d8b5e60a03c0a8e818cf438e2716829` | `8145d40f1b028a8f4ddd7b262d4de1e0b5e1e1f` |
