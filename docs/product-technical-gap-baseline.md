...
Observed at (UTC): `2026-09-04T17:52:06Z`.
...
- Full live search returns **146 open pull requests: 5 Ready/non-draft and 141 Draft; 13 open non-PR issues**. Queue movement is not protected-main delivery.
...
- PR #229 is Draft at exact head `7aa30c57a4af724eb4e601c52c1eaf68f27d1712`. Its presentation-identity work retains the boundary that Chromium application and page-observed effectiveness remain separate adapter/browser-E2E work. Current-head CI/security runs remain non-terminal.
