...
Observed at (UTC): `2026-09-04T23:23:16Z`.
...
- Full live search returns **124 open pull requests: 9 Ready/non-draft and 115 Draft; 13 open non-PR issues**. PR #247 also became Ready on a new exact head while this snapshot was being refreshed; queue movement is not protected-main delivery.
