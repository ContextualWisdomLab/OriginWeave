...
- `SameDocumentMutationKind` rotation of `DocumentEpoch` when a same-document replacement, role/name change, accessibility invalidation, frame replacement, or actionable subtree change can alter the target;
