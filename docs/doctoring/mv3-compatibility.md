...
| Content-script injection + isolated fixture page | **PROTECTED_MAIN** | Controlled content script mutates bounded DOM evidence on loopback. | This is not a general raw-DOM or arbitrary-script Agent API. |
