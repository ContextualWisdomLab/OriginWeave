...
- [ADR 0015: Benchmark release acceptance evidence and safety gates](adr/0015-benchmark-release-acceptance.md)
- [ADR 0016: BAP task lifecycle and state authority](adr/0016-bap-task-lifecycle-authority.md)

ADR 0015 belongs to the active benchmark release-acceptance feature branch. It records typed and bounded release-evidence semantics while preserving a separate higher-level release authority; its presence here is not protected-main implementation evidence and its lifecycle remains Proposed.

ADR 0016 is owned by the active BAP lifecycle feature branch and remains Proposed. Its presence here makes the branch documentation graph complete without presenting the decision or implementation as protected-main truth before integration.
