...
- [Research and standards](doctoring.md)
  ...
  - [Rust toolchain freshness and reproducibility](doctoring/rust-toolchain-freshness.md)
...
- [ADR 0115: Rust stable toolchain baseline](adr/0115-rust-stable-toolchain-baseline.md)
