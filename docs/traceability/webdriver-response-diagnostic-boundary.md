...
The browser evidence lane therefore had a provenance mismatch. A remote response was allowed to decide failure and also become operator-visible diagnostic text without an explicit redaction boundary.
