...
1. Obtain independent current-head review of the split GCC-specs RED→repair chain together with the retained linker-plugin and executable-selection contracts.
