...
- **Test/release/traceability:** #67 and #68 both have exact-head green CI/coverage evidence, but remain active/non-shipped and dependency-gated where stacked. No predecessor-head success is transferable.
