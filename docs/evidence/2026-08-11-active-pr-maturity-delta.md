...
- **Test/release/traceability:** #67 has exact-head green evidence. #68 remains `PARTIAL` until the unchanged current head proves exact coverage and the other applicable gates. No predecessor-head success is transferable.
