...
- **Test/release/traceability:** #67 and #68 both have fresh exact-head green CI/coverage evidence while remaining active/non-shipped and dependency-gated where stacked. No predecessor-head success is transferable.
