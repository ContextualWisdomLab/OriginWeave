...
PR #293 was merged into PR #229 on 2026-09-09, so its `originweave-bidi` capability boundary is inherited by this parent rather than remaining a separate active stacked slice. The adapter remains runtime-qualified 3 September 2026 against the immutable WebDriver BiDi Working Draft URI `https://www.w3.org/TR/2026/WD-webdriver-bidi-20260903/`. A fresh 2026-09-20 read of W3C's canonical latest-published page and publication history also identifies the latest published 3 September 2026 Working Draft, with 1 September 2026 as the previous published version. Earlier OriginWeave prose naming 16 September and 14 September dated Technical Reports was unsupported by the canonical W3C publication history and is withdrawn. Publication freshness is recorded separately in `docs/traceability/webdriver-bidi-publication-current.md`; the mutable Editor's Draft remains a separate research surface. A newer runtime pin still requires a dedicated compatibility/conformance change and pinned-browser evidence.
...
World Wide Web Consortium. (2026, September 3). *WebDriver BiDi* [Working Draft; latest publication observed 2026-09-20 and runtime-qualified OriginWeave adapter pin]. https://www.w3.org/TR/2026/WD-webdriver-bidi-20260903/

World Wide Web Consortium. (2026, September 1). *WebDriver BiDi* [Working Draft; previous published version]. https://www.w3.org/TR/2026/WD-webdriver-bidi-20260901/
