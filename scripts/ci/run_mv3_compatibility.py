...
def _wait_for_linux_process_teardown(
    ...
    *,
    ...
    """Observe root and sampled-set termination under one monotonic deadline."""

    if isinstance(root_process_id, bool) or not isinstance(root_process_id, int) or root_process_id <= 0:
